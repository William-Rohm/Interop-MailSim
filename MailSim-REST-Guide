...
This test traffic is designed to exercise an Outlook-compatible email server in a multi-client environment for extended periods. During execution, MailSim displays client-side process messages, and also stores those messages in log files, for monitoring and troubleshooting.

**Note:** The [MailSim User Guide](https://github.com/OfficeDev/Interop-MailSim/wiki/MailSim-User-Guide) describes 
how to set a MailSim testing environment, and how to use each operation.
...
This initial release of MailSim is shown as Phase 1 in this diagram.

![MailSim architecture diagram](https://cloud.githubusercontent.com/assets/13560879/9142952/f398fce2-3cf7-11e5-8b5f-80c8ab21fcb4.png)
...
October 7 2015 - Initial release
